...
<html lang="en">
    ...
    <body>
        ...
        <?php $askgogo->show_slider('hielo_main_slider'); ?>
        <?php $askgogo->show_info_blocks('hielo_main_info_blocks'); ?>
        <?php $askgogo->show_parallax_div('hielo_main_parallax_div'); ?>
        <footer id="footer">
            <div class="container">
                <ul class="icons">
