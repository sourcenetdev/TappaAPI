    ...
    */
    ...
    Grid.defaults = {
        ...
        templates: {
            ...
            search: "<div class=\"{{css.search}}\"><div class=\"input-group\"><span class=\"{{css.icon}} input-group-addon {{css.iconSearch}}\"></span> <form name=\"csrflistingfrm\"><input type=\"hidden\" name=\"<?php echo $ci->security->get_csrf_token_name(); ?>\" value=\"<?php echo $ci->security->get_csrf_hash(); ?>\"><input type=\"text\" class=\"{{css.searchField}}\" placeholder=\"{{lbl.search}}\" /></form></div></div>",
