        ...
        <div class="m-t-20 p-t-0 p-l-25 p-r-25 p-b-25">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div role="alert" class="alert alert-danger"><?php echo $empty['message']; ?></div>
                            <a class="btn btn-primary" href="__BASE__widget/load_widget/slider/add_slider_item/<?php echo $id; ?>"><?php echo $empty['button']; ?></a>
                        </div>
                    </div>
                    <?php endif; ?>
                </div>
