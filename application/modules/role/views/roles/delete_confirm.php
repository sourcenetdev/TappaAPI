    ...
    <div class="p-t-0 p-l-25 p-r-25 p-b-25">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-6">
                ...
                <?php echo kcms_form_submit($data['fields']['role_submit']); ?>&nbsp;
                <a class="btn btn-secondary" href="<?php echo base_url(); ?>user/list_roles_data"><?php echo $data['messages']['return']; ?></a>
            </div>
        </div>
