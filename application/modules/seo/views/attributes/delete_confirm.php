    ...
    <div class="p-t-0 p-l-25 p-r-25 p-b-25">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-6">
                ...
                <?php echo kcms_form_submit($data['fields']['attribute_submit']); ?>&nbsp;
                <a class="btn btn-secondary" href="<?php echo base_url(); ?>seo/list_attributes"><?php echo $data['messages']['return']; ?></a>
            </div>
        </div>
