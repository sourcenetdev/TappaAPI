...
*/
class PayU_v2_model extends CI_Model
{
    private $tables;
    private $date_format;
    ...
    public function setTransactionSave($saveData, $transactionType = 'PAYMENT')
    {
        ...
        if (empty($saveData)) {
            $err = [
                'status' => -1,
                'error' => lang('payu_v2_model_no_set_transaction_data'),
            ];
        ...
        if (empty($res)) {
            ...
            $err = [
                'status' => -2,
                'error' => lang('payu_v2_model_transaction_exists'),
            ];
    ...
    public function setTransactionGet($reference)
    {
        ...
        $err = [
            'status' => -1,
            'error' => lang('payu_v2_model_no_setTransaction_found')
        ];
    ...
    public function doTransactionSave($saveData, $transactionType = 'FINALIZE')
    {
        ...
        if (!empty($res)) {
            ...
            $err = [
                'status' => -2,
                'error' => lang('payu_v2_model_transaction_does_not_exist'),
            ];
